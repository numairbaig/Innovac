...
export default function AdminForgotPassword() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#050505] relative overflow-hidden py-16 px-4">
      ...
      <SEO title="Forgot Password | Admin Control Center" />
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-medium tracking-tight text-white mb-3">Reset Admin.</h1>
          <p className="text-neutral-400 text-sm leading-relaxed">
            Enter your admin email address to request a secure password recovery link.
          </p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/10 text-center text-sm">
          <Link to="/admin/login" className="text-neutral-400 hover:text-white transition-colors text-xs uppercase tracking-wider font-semibold">
            Back to Admin Login
          </Link>
        </div>
      </motion.div>
