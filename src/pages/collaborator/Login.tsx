...
export default function CollaboratorLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (role !== 'COLLABORATOR' && role !== 'ADMIN' && role !== 'SUPER_ADMIN') {
        throw new Error('Access denied. This portal is for collaborators only.');
      }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F5F5F3] relative overflow-hidden py-16 px-4">
      ...
      <SEO title="Collaborator Login | INNOVAC BIOTECHNOLOGIES" />
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-medium tracking-tight text-[#080808] mb-3">Collaborator Portal.</h1>
          <p className="text-[#6A6A6A] text-sm leading-relaxed">
            Secure client workspace for authorized research collaborators and project partners.
          </p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                placeholder="collaborator@partner.com"
              />
            </div>
          </div>
          ...
          <div className="pt-2">
            ...
            >
              {loading ? 'AUTHENTICATING...' : 'COLLABORATOR SIGN IN →'}
            </Button>
          </div>
        </form>
      </motion.div>
