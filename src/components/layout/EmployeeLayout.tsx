...
export function EmployeeLayout() {
  ...
  const navigation = [
    ...
    { name: 'Research', href: '/employee/research', icon: FlaskConical },
    ...
    { name: 'Announcements', href: '/employee/notifications', icon: Bell },
  ];

  return (
    <div className="min-h-screen bg-[#F5F5F3] flex text-[#080808] font-sans antialiased">
      <SEO title="Employee Portal | INNOVAC BIOTECHNOLOGIES" />
      ...
      >
        <div className="h-20 flex items-center justify-between px-6 border-b border-[#D8D8D5] bg-white">
          <Link to="/employee/dashboard" className={cn("font-bold text-[#080808] tracking-tight text-lg truncate flex items-center gap-2", !sidebarOpen && "lg:hidden")}>
            INNOVAC <span className="text-[#FF4D00] font-semibold">EMPLOYEE</span>
          </Link>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 border-l border-[#D8D8D5] pl-6">
              <div className="text-right hidden sm:block">
                ...
                <p className="text-[10px] font-bold text-accent uppercase tracking-widest mt-0.5">{profile?.role || 'Employee'}</p>
              </div>
